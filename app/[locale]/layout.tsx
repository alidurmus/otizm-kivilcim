...
export default async function RootLayout({
  ...
  return (
    <html lang={locale} className={`${geist.variable} ${geistMono.variable} antialiased min-h-screen font-sans`} data-test-env={isTestEnv ? 'true' : 'false'} suppressHydrationWarning>
      <head>
